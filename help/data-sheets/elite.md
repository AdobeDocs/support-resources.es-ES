...
# Compatibilidad con Elite

![icono](assets/Elitebanner.png)

Los servicios de soporte de Adobe Experience Cloud Elite ofrecen los mejores destinos de nivel de servicio (SLT), soporte proactivo y colaboración con un administrador de cuentas técnico y un ingeniero de soporte designado.
...
| Prioridad | Asistencia en línea | Compatibilidad con Elite |
|--- |--- |--- |
| <b>PRIORIDAD 1</b><br>Las funciones comerciales de producción del cliente están inactivas o tienen una pérdida de datos o degradación del servicio significativa, y se requiere atención inmediata para restaurar la funcionalidad y la facilidad de uso. | 24x7/<br>1 hora | 24x7/<br>15 minutos |
| <b>PRIORIDAD 2</b><br>Las funciones comerciales del cliente tienen una importante degradación del servicio o una posible pérdida de datos, o una característica importante se ve afectada. | Horario de trabajo/<br>4 horas | 24x5/<br>30 minutos |
| <b>PRIORIDAD 3</b><br> Las funciones comerciales del cliente tienen una degradación de servicio menor o nula, pero existe una solución/solución que permite que las funciones comerciales continúen normalmente. | Horario de trabajo/<br>6 horas | 24x5/<br> 1 hora |
...
## Funciones de soporte de Elite

<table style="table-layout:fixed">
<tr>
  <td>
    <img alt="Administrador técnico de cuentas" src="assets/namedsupportengineer.png"/>
    <div>
    <p><b>Administrador técnico de cuentas</b></p>
    <p>Un administrador de cuentas técnico designado para supervisar su experiencia de Elite, coordinar las contrataciones de asistencia y servicios de campo y proporcionar servicios proactivos para maximizar el valor comercial.</p>
    </div>
  </td>
  <td>
    ...
    <p>Un ingeniero de soporte designado que se familiarice con el entorno de su solución y los objetivos del negocio. El NSE es un ingeniero de soporte experimentado que ayuda a coordinar su experiencia de soporte de Elite.</p>
    </div>
  </td>
  <td>
...
<tr>
  ...
  <td>
    ...
    <p>Una revisión periódica de los servicios de los programas Elite, las métricas de soporte y los entregables, incluyendo un plan de entrega orientado al futuro.</p>
    </div>
  </td>
  <td>
...
<tr>
  <td>
    ...
    <p>Revisión proactiva de la implementación, configuración y arquitectura general de la solución, incluidas las integraciones.</p>
    </div>
  </td>
  <td>
    <img alt="Revisión del plan de trabajo de las soluciones" src="assets/SolutionRoadmapReview.png"/>
    <div>
    <p><b>Revisión del plan de trabajo de las soluciones</b></p>
  ...
  <td>
    <img alt="Mantenimiento y supervisión" src="assets/MaintenanceMonitoring.png"/>
    <div>
    <p><b>Mantenimiento y supervisión</b></p>
    <p>Reciba las prácticas recomendadas de mantenimiento y las correcciones más recientes (SP, MR, parches, FP) para mantenerse actualizado en todas las comprobaciones de mantenimiento</p>
    </div>
  </td>
</tr>
<tr>
  <td>
    ...
    <p>Reciba orientación personalizada sobre las nuevas funciones de producto para aprovechar las últimas innovaciones y pida a los expertos en Adobe que revisen la versión y el plan de actualización.</p>
    </div>
  </td>
  <td>
  ...
  <td>
    ...
    <p>Administre eventos clave para garantizar que dispone del nivel adecuado de asistencia, cobertura y plan de mitigación durante esos hitos clave del negocio y del proyecto.</p>
    </div>
  </td>
</tr>
</table>
...
Los expertos en soluciones de Adobe ayudan a validar los requisitos, la arquitectura, el proceso de desarrollo y los exámenes de preparación para el lanzamiento con directrices basadas en las mejores prácticas para los clientes y los socios de implementación.
...
Como cliente de Elite, puede optar a **4 actividades al año** en las dos vías siguientes: **Técnico** o **Estratégico**.
