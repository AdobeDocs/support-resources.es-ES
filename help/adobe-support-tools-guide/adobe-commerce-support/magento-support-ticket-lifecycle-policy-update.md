...
* [Información general sobre los planes de éxito de Adobe: ciclo vital del caso de asistencia](https://experienceleague.adobe.com/es/docs/support-resources/data-sheets/overview#support-case-lifecycle---coming-soon)
