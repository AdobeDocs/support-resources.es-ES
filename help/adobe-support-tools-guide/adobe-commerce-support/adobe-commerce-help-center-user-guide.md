...
1. Vaya a [experienceLeague.adobe.com](https://experienceleague.adobe.com/es?lang=es).
1. Inicie sesión con sus credenciales de inicio de sesión de Adobe.

![iniciar sesión en experience-league](/help/adobe-support-tools-guide/assets/experience_league_sign_in.png)
...
>
>* La organización en cuestión recibe su nombre en la columna izquierda y termina en (Commerce). El problema está relacionado con esa organización o una cuenta asociada con ella.
...
>
>Para problemas relacionados con la publicación de su extensión, problemas para comprar o solicitar un reembolso en [Adobe Commerce Marketplace](https://commercemarketplace.adobe.com/), debe ponerse en contacto directamente con el equipo de [!DNL Commerce Marketplace] visitando https://commercemarketplace.adobe.com/. Vaya a la parte inferior de la página y haga clic en **[!UICONTROL Póngase en contacto con nosotros]**, que abrirá un formulario para enviar un ticket de asistencia técnica de Marketplace.

#### Página de inicio de Adobe Experience League {#experience-league-start-page}

Para enviar un nuevo caso de soporte técnico usando la página de inicio de Adobe Experience League, consulte [Crear un ticket de soporte técnico con Experience League](https://experienceleague.adobe.com/es/docs/support-resources/adobe-support-tools-guide/adobe-customer-support-experience#create-a-support-ticket-with-experience-league).
...
>1. Si pertenece a varias organizaciones o hay varias con nombres de aspecto similar (cada una representará a cualquiera de los demás productos de Adobe a los que la organización tiene suscripciones), primero deberá seleccionar la organización adecuada en el menú desplegable de la columna izquierda que termina en *[!DNL (Commerce)]*.
>1. Si la lista desplegable **[!UICONTROL Seleccionar un producto]** está vacía al enviar un caso, probablemente esté usando una cuenta de socio de Adobe Commerce. Solo los usuarios con [acceso compartido](#shared-access) de un comerciante con derechos de asistencia pueden enviar tickets. Para problemas de comerciantes, solicite acceso compartido. Para problemas de socios, póngase en contacto con spphelp@adobe.com.
...
>
>Además, si se seleccionó la organización incorrecta en el momento en que se envió el caso, su equipo no podrá ver el caso en **[!UICONTROL Mis casos]** para la organización correcta o apropiada. El equipo de Soporte de Adobe Commerce no tiene la capacidad de cambiar la organización asociada con el caso; para solucionar esto, debe cerrar el caso existente y enviar un nuevo caso con los detalles apropiados proporcionados/seleccionados.

>[!NOTE]
>
>Si envía un ticket con &quot;**[!DNL Commerce]en la infraestructura en la nube**&quot; seleccionado como producto y la organización tiene varios proyectos enumerados, se le pedirá que seleccione el **[!UICONTROL ID de proyecto]** apropiado. Si no puede encontrar el **[!UICONTROL Id. de proyecto]** deseado, asegúrese de agregar una nota en el ticket que indique que está buscando ayuda con un &quot;proyecto X&quot; diferente.<br>Si tiene intención de enviar un ticket de &quot;**[!DNL Commerce]en Managed Services**&quot; y está en **[!DNL Commerce]en la infraestructura en la nube**, pero no ve **[!DNL Commerce]en la infraestructura en la nube** como un producto disponible:<br>1. Escriba un asunto para su problema en **[!UICONTROL Título del caso]**.<br>2. Escriba una descripción de su problema en **[!UICONTROL Descripción del caso]**.<br>3. Después de ingresar ambos elementos, se le mostrará el campo **[!UICONTROL URL del proyecto en la nube]** a continuación.
...
>1. Si envió el caso para OrgA-Product1 y desea revisar **[!UICONTROL Mis casos]** para esa organización en el futuro, no lo verá si selecciona OrgA-Product2 como organización (solo tendrá que seleccionar la otra organización, en comparación con el ejemplo B).
>
>**Ejemplo B**: tiene acceso compartido a dos compañías y cada compañía solo tiene derechos para Adobe Commerce.
>
>1. Si ha enviado el caso para OrgA pero el problema realmente afecta a OrgB, los miembros de OrgB no podrán ver este caso en **[!UICONTROL Mis casos]** en el futuro.
>1. Además, los miembros de OrgA podrán ver casos en **[!UICONTROL Mis casos]** que en realidad están pensados para OrgB, lo que puede conllevar problemas de privacidad.
...
>
>* Sus derechos de Commerce han caducado o están inactivos (por ejemplo, debido a un problema pendiente de facturación o licencia).
>* Para instancias alojadas en Adobe Commerce en la infraestructura en la nube (PaaS), no se le ha agregado al proyecto en la nube.
>
>Para proyectos de Adobe Commerce en la nube, póngase en contacto con el propietario de la cuenta y solicite que se le añada al proyecto de Cloud correspondiente. Para obtener más información, consulte [Administrar el acceso de los usuarios](https://experienceleague.adobe.com/es/docs/commerce-on-cloud/user-guide/project/user-access) para Adobe Commerce en la infraestructura en la nube.
>
>Una vez que se le haya concedido el acceso compartido y se le haya añadido al proyecto en la nube:
>
>1. Vaya a la página [Soporte técnico de Adobe](https://experienceleague.adobe.com/home?lang=es#support).
>1. En el menú desplegable de organización de la izquierda, seleccione la organización cuyo nombre termina con **(Commerce)**.
>1. Envíe el ticket para el producto apropiado y no seleccione **Informes de Commerce** para problemas relacionados específicamente con los Informes avanzados.
...
1. Haga clic en la ficha **Asistencia**.
   ...
   ![pestaña magento_account_support](/help/adobe-support-tools-guide/assets/magento_account_support_tab.png){width="800"}

1. La página de asistencia de Adobe Experience League se carga automáticamente.
1. Seleccione **[!UICONTROL Abrir incidencia]** en el menú de la izquierda.
1. Rellene [los campos](https://experienceleague.adobe.com/es/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-support-ticket-contact-reason-descriptions).
...
![Error_Verificar_Dirección_Correo_Electrónico](/help/adobe-support-tools-guide/assets/Verify_Email_Address_Error.png)


### Seguimiento de los casos de asistencia de Commerce {#track-support-case}
...
>[!NOTE]
>
>Si tiene casos de asistencia técnica que se enviaron con otros productos de Adobe además de Commerce, esos tickets no se pueden rastrear desde la misma pantalla. Primero debe cambiar a la organización asociada con la asignación del producto.
>Por ejemplo, anteriormente seleccionó la organización que termina en &quot;(Commerce)&quot; para rastrear su caso de Commerce, mientras que también tiene casos de asistencia de AEP; esos casos no se mostrarán aquí.

#### Ver sus casos

Puede ver los casos de Commerce que ha enviado personalmente haciendo clic en **[!UICONTROL Mis casos]** en el menú de la izquierda. Asegúrese de haber seleccionado la organización correcta que termina en &quot;(Commerce)&quot;.

![casos de compatibilidad de vista](/help/adobe-support-tools-guide/assets/view_support_cases.png)
...
Puede ver los casos de Commerce en los que se le ha *agregado como observador* haciendo clic en **[!UICONTROL Casos de mi organización]** en el menú de la izquierda.
...
Para encontrar casos, escribe tu consulta de búsqueda en el campo *[!UICONTROL Buscar]* y pulsa *Intro* en el teclado.

![search-cases](/help/adobe-support-tools-guide/assets/search_cases.png)
...
1. Haga clic en **[!UICONTROL Escalar a administración]** en la parte inferior derecha del panel *[!UICONTROL Detalles del caso]*, en la parte derecha de la pantalla.

   ![escalar a administración](/help/adobe-support-tools-guide/assets/escalate_to_management.png)

1. Después de hacer clic en, aparecerá un formulario emergente. Rellene el formulario y haga clic en **[!UICONTROL Escalar]**.

   ![confirmar-escalación](/help/adobe-support-tools-guide/assets/confirm_escalation.png)
...
1. Para añadir un observador a un caso existente, abra el caso y haga clic en el icono de lápiz situado junto a &quot;observadores&quot; en el panel Detalles del caso, en la parte derecha de la pantalla.
   ...
   ![observadores de complementos](/help/adobe-support-tools-guide/assets/add_watchers.png)

1. Después de hacer clic en el lápiz, puede agregar o quitar observadores de la lista.

   ![observadores de actualizaciones](/help/adobe-support-tools-guide/assets/update_watchers.png)

>[!NOTE]
>
>Para obtener más información sobre cómo agregar y quitar observadores para su caso, vea el vídeo [Agregar y quitar observadores, cerrar y volver a abrir vales](https://experienceleague.adobe.com/es/docs/commerce-learn/tutorials/help-and-support/add-remove-watchers-close-reopen-support-ticket).
...
1. Escriba su comentario en el campo **[!UICONTROL Comentarios]** y haga clic en **[!UICONTROL Agregar comentarios]**.

![add-comments](/help/adobe-support-tools-guide/assets/add_comments.png)

### Cierre su caso {#close-case}

Para cerrar el caso, haga clic en **[!UICONTROL Cerrar caso]** en la parte inferior derecha del panel *[!UICONTROL Detalle del caso]*.

![close-case](/help/adobe-support-tools-guide/assets/close_case.png)

>[!NOTE]
>
>Para obtener más información sobre cómo cerrar el caso, consulte el vídeo [Agregar y eliminar observadores, cerrar y volver a abrir tickets](https://experienceleague.adobe.com/es/docs/commerce-learn/tutorials/help-and-support/add-remove-watchers-close-reopen-support-ticket).

### Vuelva a abrir el caso {#reopen-case}

>[!NOTE]
>
>**Solo puede reabrir un caso dentro de los 14 días posteriores a su cierre.** Si ya han pasado 14 días desde el cierre del caso, pero aun así desea solicitar ayuda en relación con un problema, debe abrir un nuevo caso.<br>Para obtener más información sobre cómo cerrar y reabrir casos, vea el vídeo [Agregar y quitar observadores, cerrar y reabrir tickets](https://experienceleague.adobe.com/es/docs/commerce-learn/tutorials/help-and-support/add-remove-watchers-close-reopen-support-ticket).

>[!NOTE]
>
>No puedes reabrir un caso respondiendo a una notificación por correo electrónico desde un ticket cerrado. Para reabrir el caso, asegúrate de que el propietario de la cuenta te haya dado [acceso compartido](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26164).
...
1. Seleccione **[!UICONTROL Asistencia]** en el menú de usuario.
1. Se carga la página **[!UICONTROL Mis tickets]**.
1. Haz clic en **[!UICONTROL Enviar un ticket]** en la esquina superior derecha.
1. Rellene [los campos](https://experienceleague.adobe.com/es/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-support-ticket-contact-reason-descriptions).
...
![permisos de administración compartida de cuentas de magento](/help/adobe-support-tools-guide/assets/magento_account_shared_manage_permissions.png)
...
1. Busque el usuario desde el que desea revocar el acceso compartido y haga clic en ![quitar icono](/help/adobe-support-tools-guide/assets/remove_icon.png){width="25"} en la fila del usuario (columna **Acciones**).
1. Haga clic en **Eliminar usuario** para revocar el acceso o en X en la esquina superior para cancelar la revocación.

   ![revocar_acceso_compartido](/help/adobe-support-tools-guide/assets/revoke_shared_access.png){width="800"}
...
Si tiene o ha tenido un proyecto de Adobe Commerce Cloud y ha agregado un usuario al proyecto, es posible que se le haya concedido automáticamente acceso compartido en el ID de IMAGEN del propietario del proyecto. Esto normalmente se indicaría en la columna **[!UICONTROL Nombre del recurso compartido]**, que muestra *Acceso compartido en la nube desde MAG[XYZ]*.
...
1. Inicie sesión en su cuenta de Adobe Commerce en [https://account.magento.com](https://account.magento.com/).
1. En el panel de la izquierda, en **[!UICONTROL Acceso compartido]**, seleccione **[!UICONTROL Administrar permisos]**.
1. Busque el usuario desde el que desea revocar el acceso compartido y haga clic en **[!UICONTROL Editar]** en la fila del usuario (columna *[!UICONTROL Acciones]*).
1. Desmarque todos los recursos bajo **[!UICONTROL Conceder permisos de cuenta]**.
1. Para evitar confusiones sobre si el usuario sigue teniendo **[!UICONTROL Acceso compartido en la nube]**, debe modificar **[!UICONTROL Nombre del recurso compartido]** por un nombre como, por ejemplo: *Acceso compartido en la nube revocado - no se puede eliminar*, o algo similar.
...
### Acceder a su cuenta compartida (cambiar de cuenta) {#switch-accounts}

>[!NOTE]
>
>Este paso no es necesario para enviar tickets para Adobe Commerce.
>Para ver una demostración sobre cómo enviar un ticket de Adobe Commerce, [vea este vídeo](https://experienceleague.adobe.com/es/playlists/support-requests).
...
1. Haga clic en el menú **Cambiar cuentas** y seleccione una cuenta.
   ...
   ![conmutador-compartido-cuenta-magento](/help/adobe-support-tools-guide/assets/magento_account_shared_switch.png){width="800"}
...
Consulte el [artículo de solución de problemas con acceso compartido](https://experienceleague.adobe.com/es/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/shared-access-troubleshooting) en nuestra base de conocimiento de asistencia.
