...
1. Para enviar un caso, selecciona **[!UICONTROL Abrir un ticket de asistencia]**. También puede seleccionar **[!UICONTROL Abrir incidencia]** en el menú de la barra lateral.
   ...
   ![Experience league abre un ticket](./assets/open-support-ticket.png)

### Rellene el ticket de asistencia

Después de seleccionar **[!UICONTROL Abrir una incidencia de soporte técnico]** o **[!UICONTROL Abrir incidencia]**, aparecerá la página de creación de casos.

El formulario utiliza un flujo de trabajo guiado de varios pasos:

* Seleccione el producto de Adobe afectado
* Describir el problema
* Proporcionar detalles del sistema y del entorno
* Indicar impacto y urgencia
* Confirmar información de contacto
* Revise y envíe los detalles
...
1. Haga clic en el nombre del producto para seleccionar el producto afectado y, a continuación, haga clic en **[!UICONTROL Siguiente]**.
   ...
   ![Experience league selecciona un producto](./assets/select-product.png)

1. En la sección **[!UICONTROL Detalles del problema]**, escriba el título del caso, describa el problema y proporcione los pasos para reproducirlo.

   ![Detalles del problema de Experience League](./assets/issue-details.png)

   Incluir detalles como:

   * Lo que está intentando hacer
   * Lo que no funciona como se esperaba
   * Cualquier cambio reciente del entorno
   * Pasos que ya ha realizado

   A medida que introduce detalles del problema, Experience League muestra recomendaciones impulsadas por IA en un panel junto al formulario. Estas recomendaciones:
...
1. En la sección **[!UICONTROL Información del sistema]**, seleccione el entorno y haga clic en **[!UICONTROL Siguiente]**.
   ...
   ![Información del sistema de Experience League](./assets/system-information.png)

1. En la sección **[!UICONTROL Impacto]**, seleccione lo siguiente:
   * Prioridad De Caso (P4 - Menor, P3 - Importante, P2 - Urgente, P1 - Crítico)
   * Impacto en la empresa (pequeña, Medium, grande)

   ![Detalles de impacto de Experience League](./assets/impact.png)
...
1. En la sección **[!UICONTROL Información de contacto]**, selecciona la zona horaria, escribe tu número de teléfono, agrega vigilantes, adjunta los archivos si es necesario y, a continuación, haz clic en **[!UICONTROL Siguiente]**.

   ![Información de contacto de Experience League](./assets/contact-information.png)

1. En la sección **[!UICONTROL Revisar y enviar]**, revisa los detalles de tu caso y haz clic en **[!UICONTROL Enviar]**.

   ![revisión y envío de Experience League](./assets/review-and-submit.png)
