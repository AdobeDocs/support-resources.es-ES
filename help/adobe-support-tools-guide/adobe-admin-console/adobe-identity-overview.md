...
>[!NOTE]
>Si su organización no se ha actualizado al modelo de almacenamiento empresarial de Adobe y aún utiliza Adobe ID para personas, consulte la descripción en la [tabla de tipos de identidad](https://helpx.adobe.com/es/enterprise/using/identity.html#using-personal-adobe-id) a continuación.
