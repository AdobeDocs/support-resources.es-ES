...
<td><a href="https://helpx.adobe.com/manage-account/using/change-or-reset-password.html">Restablecer la contraseña de la cuenta</a></td>
</tr>
<tr>
...
<tr>
<th scope="row"><strong>Restablecer contraseña</strong></th>
<td><a href="https://helpx.adobe.com/manage-account/using/change-or-reset-password.html">Restablecer la contraseña de la cuenta.</a>  Consulte el punto 2 de la sección de notas siguiente.</td>
</tr>
<tr>
<th scope="row"><strong>Creative Cloud para empresas y Document Cloud para empresas</strong></th>
<td>Admitido</td>
...
- [Cambiar la identidad del usuario](https://helpx.adobe.com/enterprise/using/switch-user-identity.html)
...
- [Preguntas frecuentes sobre educación](https://helpx.adobe.com/x-productkb/policy-pricing/education-faq.html)
