...
1. Seleccione **[!UICONTROL Agregar administrador]**.
   ...
   ![Administrador de adición de Global Admin Console](../assets/global-admin-console-add-admin.png)
...
1. Seleccione uno o más roles de administrador de la sección **[!UICONTROL Derechos de administrador]**.
   ...
   ![Administrador de adición de Global Admin Console](../assets/global-admin-console-add-admin-detail.png)

1. Seleccione **[!UICONTROL Guardar]**.

1. Después de editar las organizaciones, seleccione **[!UICONTROL Revisar cambios pendientes]** y, a continuación, seleccione **[!UICONTROL Enviar cambios]** para [ejecutar](https://helpx.adobe.com/es/enterprise/global-admin-console/execute-jobs.html) los cambios.
...
Una vez agregado el administrador, recibe un mensaje de correo electrónico en el que se le invita a aceptar su función y se le asigna un vínculo a Admin Console. Si se agregan como administradores globales y como otros roles, recibirán dos invitaciones, una a Global Admin Console y otra a Admin Console.
...
1. Seleccione el icono **[!UICONTROL Más opciones]** (⋮) del administrador correspondiente y, a continuación, seleccione **[!UICONTROL Editar administrador]**.
   ...
   ![Global Admin Console editar derechos de administrador](../assets/global-admin-console-edit-admin-right.png)
...
Aparece un comando independiente en la lista de cambios pendientes para cada rol de administrador agregado o quitado. Después de revisarlos, selecciona **[!UICONTROL Enviar cambios]** para [ejecutarlos](https://helpx.adobe.com/es/enterprise/global-admin-console/execute-jobs.html).
...
1. Seleccione el icono **[!UICONTROL Más opciones]** (⋮) del administrador correspondiente y, a continuación, seleccione **[!UICONTROL Quitar derechos de administrador]**.
   ...
   ![Global Admin Console quitó los derechos de administrador](../assets/global-admin-console-remove-admin-right.png)
