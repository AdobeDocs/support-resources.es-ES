...
Una vez que obtenga acceso de [a Global Admin Console](https://experienceleague.adobe.com/es/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/adopt-global-administration#request-access-to-the-global-admin-console), podrá crear nuevas organizaciones, agregar organizaciones existentes a la jerarquía, eliminar organizaciones y cambiar una organización principal. Vaya aquí para [iniciar sesión en Global Admin Console](https://global-admin-console.adobe.com/).

En Global Admin Console, una organización es una Adobe Admin Console, una estructura utilizada para administrar los productos y usuarios de Adobe para una entidad de su empresa. [Adobe Admin Console](https://experienceleague.adobe.com/es/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/admin-console-overview) permite a los administradores del sistema administrar la implementación, los usuarios y las licencias dentro de esa consola. [Global Admin Console](https://experienceleague.adobe.com/es/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/adopt-global-administration) permite a los administradores globales crear, reparar y eliminar Admin Consoles secundarias (organizaciones secundarias) en la jerarquía y asignar productos de las consolas principales a las secundarias.

## Creación de una organización secundaria

>[!NOTE]
>
> Una organización secundaria es un Adobe Admin Console secundario. Al crear una, se agrega una nueva consola a la jerarquía de Global Admin Console.
...
5. Seleccione **[!UICONTROL Revisar cambios pendientes]** después de haber terminado de editar las organizaciones. Después de revisarlos, selecciona **[!UICONTROL Enviar cambios]** para [ejecutarlos](https://helpx.adobe.com/es/enterprise/global-admin-console/execute-jobs.html).
...
1. Inicie sesión en [Global Admin Console](https://global-admin-console.adobe.com/). Vaya a la pestaña **[!UICONTROL Organizaciones]** y seleccione la organización que desee eliminar.
...
Los cambios se registran en el registro de auditoría, se notifica a todos los usuarios por correo electrónico y el nombre no se puede actualizar de nuevo durante 24 horas. [Obtenga información sobre cómo ver y descargar registros de auditoría](https://experienceleague.adobe.com/es/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/download-audit-logs-and-export-reports).

## Cambiar el elemento principal de una organización

Como [administrador global](https://experienceleague.adobe.com/es/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/manage-administrators), puede reparar una organización en la jerarquía de organizaciones con el botón **[!UICONTROL Cambiar jerarquía]**.
...
- Las [directivas](https://helpx.adobe.com/es/enterprise/global-admin-console/update-policies.html) de la organización de las organizaciones movidas se actualizan para que cualquier bloqueo de directivas sea mantenido por una organización en la nueva jerarquía.
...
- La reparación también afecta a los productos disponibles en las organizaciones trasladadas. Cuando sea posible, [las asignaciones de productos](https://helpx.adobe.com/es/enterprise/global-admin-console/allocate-products.html) se actualizarán para que lleguen a través de la nueva ubicación principal.
...
Una vez completado el trabajo, puede ir a Asignación de productos y [cambiar los valores de concesión](https://helpx.adobe.com/es/enterprise/global-admin-console/allocate-products.html) para reflejar el cambio en la asignación de recursos de productos.

## Añadir organizaciones existentes mediante el asignador de organizaciones

Como [Administrador global](https://experienceleague.adobe.com/es/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/manage-administrators), puede agregar organizaciones existentes que actualmente no forman parte de su jerarquía de Global Admin Console a la jerarquía de organizaciones.
...
Más información sobre las [limitaciones de la asignación de productos](https://helpx.adobe.com/es/enterprise/global-admin-console/allocate-products.html#limitations).
