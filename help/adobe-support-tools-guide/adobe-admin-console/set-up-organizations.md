...
Una organización es una estructura que se utiliza para administrar productos y usuarios de Adobe. [Adobe Admin Console](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/admin-console-overview) permite a los administradores administrar la implementación y configuración de los productos y usuarios de su organización. [Global Admin Console](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/adopt-global-administration) permite a los administradores globales crear, administrar y eliminar varias organizaciones.
