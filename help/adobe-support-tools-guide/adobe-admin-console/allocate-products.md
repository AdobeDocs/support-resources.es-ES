...
En [Global Admin Console](https://helpx.adobe.com/es/enterprise/global-admin-console/adopt-global-administration.html), vaya a la pestaña **[!UICONTROL Asignación de productos]** y seleccione un producto para asignarlo a organizaciones secundarias.
...
La pestaña **[!UICONTROL Asignación de productos]** de Global Admin Console muestra las unidades de asignación de productos comprados en toda la jerarquía de la organización. Como [administrador global](https://helpx.adobe.com/es/enterprise/global-admin-console/manage-administrators.html#admins), puede asignar estos recursos de productos a otra organización en el árbol de organizaciones y especificar la cantidad que desea asignar. Como [visor global](https://helpx.adobe.com/es/enterprise/global-admin-console/manage-administrators.html#admins), puede ver y exportar los datos, pero no puede realizar ninguna actualización.
...
Como [administrador global](https://helpx.adobe.com/es/enterprise/global-admin-console/manage-administrators.html#admins), puede permitir la sobreasignación de recursos.
