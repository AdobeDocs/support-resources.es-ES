---
title: Exigir la caducidad de la contraseña en Admin Console
description: Descubra cómo los administradores del sistema de la organización pueden establecer un límite de tiempo de caducidad de contraseña para sus usuarios en Adobe Admin Console.
...
1. Vaya a la sección [Adobe Admin Console](https://adminconsole.adobe.com/settings) **[!UICONTROL Configuración]** y expanda la opción **[!UICONTROL Privacidad y seguridad]** en la esquina superior izquierda.

1. Seleccione **[!UICONTROL Configuración de autenticación]**.
