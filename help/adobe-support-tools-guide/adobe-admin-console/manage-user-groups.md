...
5. Seleccione **[!UICONTROL Revisar cambios pendientes]** para revisar las actualizaciones. A continuación, seleccione **[!UICONTROL Enviar cambios]** para [ejecutarlos](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/set-up-organizations).
...
8. Seleccione **[!UICONTROL Revisar cambios pendientes]** para revisar las actualizaciones. A continuación, seleccione **[!UICONTROL Enviar cambios]** para [ejecutarlos](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/set-up-organizations).

   Los eventos de proyección de grupo se registran para su referencia. Aprenda a [ver y descargar registros de auditoría](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/download-audit-logs-and-export-reports).
...
7. Seleccione **[!UICONTROL Revisar cambios pendientes]** para revisar las actualizaciones. A continuación, seleccione **[!UICONTROL Enviar cambios]** para [ejecutarlos](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/set-up-organizations).
...
4. Seleccione **[!UICONTROL Revisar cambios pendientes]** para revisar las actualizaciones. A continuación, seleccione **[!UICONTROL Enviar cambios]** para [ejecutarlos](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/set-up-organizations).
...
4. Después de editar las organizaciones, seleccione **[!UICONTROL Revisar cambios pendientes]** para revisarlos. A continuación, seleccione **[!UICONTROL Enviar cambios]** para [ejecutarlos](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/set-up-organizations).
