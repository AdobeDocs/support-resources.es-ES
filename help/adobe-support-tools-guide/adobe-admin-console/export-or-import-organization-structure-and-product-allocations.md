...
Acceda a la ficha **[!UICONTROL Organizaciones]** en [Global Admin Console](https://experienceleague.adobe.com/es/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/adopt-global-administration) para exportar o importar la estructura de la organización. Vaya a la pestaña **[!UICONTROL Asignación de productos]** para ver los datos de asignación. Seleccione el icono **[!UICONTROL Más opciones]** (⋮) y, a continuación, elija **[!UICONTROL Exportar]** o **[!UICONTROL Importar]**. Vaya aquí para [iniciar sesión en Global Admin Console](https://global-admin-console.adobe.com).
...
<tr>
    ...
    <td>
      ...
      Al actualizar, se aplican restricciones significativas, incluido que el nuevo elemento principal está en la misma jerarquía y
...
<tr>
    <td>adminType</td>
    <td>Uno de los siguientes: ADMINISTRADOR GLOBAL, VISOR GLOBAL, ADMINISTRADOR DEL SISTEMA, ADMINISTRADOR DE GRUPOS DE USUARIOS, ADMINISTRADOR DE PRODUCTOS, ADMINISTRADOR DE PERFILES DE PRODUCTOS, ADMINISTRADOR DE IMPLEMENTACIÓN y STORAGE_ADMIN.</td>
    <td rowspan="5">Se puede establecer cuando operation=Create</td>
  </tr>
...
- El campo seleccionado en el recurso controla si el servicio está habilitado.
...
El campo de recursos solo está presente para el formato JSON. Para los formatos CSV y XLSX, los recursos se representan con los siguientes campos adicionales: resourceName, resourceId, resourceDescription, icon, selected, quota, resourceType. Para obtener más información sobre estos campos, consulte la sección titulada Productos y recursos.
...
<tr>
    <td>seleccionado</td>
    <td>
      Para una entrada de configuración, si la función está habilitada.
      Este campo solo está presente en JSON.
    </td>
    <td rowspan="2">
      Se puede establecer o actualizar cuando operation=create u operation=update, respectivamente.
    </td>
...
<tr>
    <td>cuota</td>
    <td>
      Cantidad de recurso principal que se puede entregar a los usuarios a través de este perfil de producto.
      Este campo solo está presente en JSON.
    </td>
  </tr>
...
<tr>
    <td>resourceType</td>
    <td>
      Si está presente, el valor es SERVICIO. Indica que este recurso representa un servicio que se puede
      activada o desactivada según el valor del campo seleccionado.
      Este campo solo está presente en JSON.
    </td>
    <td>Solo lectura</td>
  </tr>
...
<tr>
    <td>userGroupId</td>
    <td>
      Identificador del grupo de usuarios. El valor de marcador de posición se puede utilizar en la creación para que
      otros objetos pueden hacer referencia al nuevo grupo de usuarios.
    </td>
    <td>Se puede establecer en un valor temporal cuando operation=create</td>
  </tr>
...
<tr>
    <td>perfiles</td>
    <td>
      Matriz de ID de perfil de producto con los que está asociado el grupo de usuarios.
      XLSX tiene una fila por valor con los mismos valores para otros campos.
    </td>
    <td>
      Se puede establecer o actualizar cuando operation=create u operation=update, respectivamente.
    </td>
...
4. Seleccione **[!UICONTROL Revisar cambios pendientes]**. Después de revisar los cambios, selecciona **[!UICONTROL Enviar cambios]** para [ejecutarlos](https://helpx.adobe.com/es/enterprise/global-admin-console/execute-jobs.html).
