...
Acceda a la ficha **[!UICONTROL Organizaciones]** en [Global Admin Console](https://helpx.adobe.com/es/enterprise/global-admin-console/adopt-global-administration.html) para exportar o importar la estructura de la organización. Vaya a la pestaña **[!UICONTROL Asignación de productos]** para ver los datos de asignación. Seleccione el icono **[!UICONTROL Más opciones]** (⋮) y, a continuación, elija **[!UICONTROL Exportar]** o **[!UICONTROL Importar]**.
Vaya aquí para [iniciar sesión en Global Admin Console](https://global-admin-console.adobe.com).
