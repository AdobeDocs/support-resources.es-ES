...
![Novedades:](../adobe-support-tools-guide/assets/new.svg) nuevas características
![Correcciones](../adobe-support-tools-guide/assets/fix.svg): correcciones y mejoras
![Errores](../adobe-support-tools-guide/assets/bug.svg): problemas conocidos

## Versión 1.0: Formulario mejorado de creación de casos

*viernes, 15 de enero de 2026*

![Nuevo](../adobe-support-tools-guide/assets/new.svg) El formulario de caso está organizado en un flujo guiado, lo que ayuda a los usuarios a comprender qué información se requiere en cada etapa:

- [!UICONTROL Selección de productos]
- [!UICONTROL Detalles del problema]
...
- **Adobe Target**
   ...
   - URL del sitio (Nombre de propiedad de etiquetas) / registro HAR o Assurance
- **Adobe Analytics**
   - RSID
...
- **Real-Time Customer Data Platform (RTCDP)**
   ...
   - Archivo HAR / Registros de Assurance
...
![Corregir](../adobe-support-tools-guide/assets/fix.svg) se agregó un asterisco (*) como indicador de campo obligatorio para garantizar la integridad y reducir los errores de envío.
